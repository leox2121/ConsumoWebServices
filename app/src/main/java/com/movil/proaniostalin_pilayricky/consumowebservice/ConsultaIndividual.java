...
public class ConsultaIndividual extends AppCompatActivity {
    ...
    Button btnconsultar,btneliminar,btneditar;
    EditText txtbuscar;
    TextView pant;
    @Override
            ...
            public void onClick(View v) {
                ...
                JsonObjectRequest peticionindivudal = new JsonObjectRequest(Request.Method
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject jsonObject) {
                                try {
                                    ...
                                    pant.setText(Union);
                                    Toast.makeText(ConsultaIndividual.this, Union, Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        Toast.makeText(ConsultaIndividual.this, "No existe Persona con el codigo ID de" + txtf, Toast.LENGTH_SHORT).show();
